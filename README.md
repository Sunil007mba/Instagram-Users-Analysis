# instaproject
This project gives an overview of user analysis, dynamics, preferences and the behaviour pattern of the users.
It helped to use the theoretical knowledge of SQL parameters for practical purpose. 
It led to logical thinking and coming to an effective conclusion for the results.

Here are the detailed report answering the questions below :
